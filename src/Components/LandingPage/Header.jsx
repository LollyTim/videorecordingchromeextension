...
const Header = () => {
    return (
			<section className="h-fit w-full flex justify-center pt-16 pb-10">
				<div className="w-11/12 h-full flex flex-col lg:flex-row gap-10 lg:gap-5 items-center">
					<section className="flex flex-col gap-6 items-center lg:items-start">
						...
						>
							Install HelpMeOut
							<img src="arrow-right.png" alt="arrow" className="w-4" />
						</a>
					</section>
					<img src="headerImg.jpg" alt="mage"/>
				</div>
			</section>
		);
}
